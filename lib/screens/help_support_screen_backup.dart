...
class _HelpSupportScreenState extends State<HelpSupportScreen> {
  ...
  // Stable unique ID for the chat widget
  late final String _uniqueChatId;

  @override
  void initState() {
    super.initState();
    _uniqueChatId = "user_${DateTime.now().millisecondsSinceEpoch}";
  }

  @override
  void dispose() {
    // Ensure we're collapsed before disposing
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Chat Widget (single instance that transforms)
          Positioned(
            ...
            child: SizedBox(
              ...
              width: viewWidth,
              child: Container(
                decoration: _isChatExpanded
                    ? null
                    : BoxDecoration(
                        borderRadius: BorderRadius.circular(40),
                      ),
                child: ChatWidget(
                  // Custom chat button (only visible when collapsed)
                  button: _isChatExpanded
                      ? const SizedBox()
                      : Container(
                          height: 80,
                          width: 80,
                  ...
                  uniqueId: _uniqueChatId, // Stable unique ID
                  name: "Academy User", // Optional: User name
  ...
  void _showEmailSupport() {
    CommonFunctions.showSuccessToast(
      'Opening email app...\nSend your questions to support@navyug',
    );
